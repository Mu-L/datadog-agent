...
build do
    ...
    block do
        ...
        if linux_target?
            ...
            move "#{install_dir}/scripts/datadog-agent-sysprobe.path", systemd_directory
            move "#{install_dir}/scripts/datadog-agent-sysprobe-stop.service", systemd_directory
            move "#{install_dir}/scripts/datadog-agent-sysprobe-stop.path", systemd_directory
            move "#{install_dir}/scripts/datadog-agent-security.service", systemd_directory
            move "#{install_dir}/scripts/datadog-agent-security.path", systemd_directory
            move "#{install_dir}/scripts/datadog-agent-security-stop.path", systemd_directory
            move "#{install_dir}/scripts/datadog-agent-security.path", systemd_directory
