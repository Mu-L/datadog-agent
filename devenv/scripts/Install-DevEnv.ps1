...
Write-Host -ForegroundColor Green "Installing go 1.21.4"

$gozip = "https://dl.google.com/go/go1.21.4.windows-amd64.zip"
if ($Env:TARGET_ARCH -eq "x86") {
    $gozip = "https://dl.google.com/go/go1.21.4.windows-386.zip"
}
