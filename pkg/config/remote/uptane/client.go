...
// WithConfigRootOverride overrides director root
...
func NewClient(cacheDB *bbolt.DB, cacheKey string, orgUUIDProvider OrgUUIDProvider, cfg model.Reader, options ...ClientOption) (c *Client, err error) {
