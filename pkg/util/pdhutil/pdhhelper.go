...
func pdhGetFormattedCounterArray(hCounter PDH_HCOUNTER, format uint32) (outItems []PdhCounterValueItem, err error) {
	...
	hdrItems := (*reflect.SliceHeader)(unsafe.Pointer(&items)) //nolint:staticcheck // TODO fix reflect.SliceHeader has been deprecated: Use unsafe.Slice or unsafe.SliceData instead
