...
// GetInfo returns information about a specific check instances. If 'includeConfig' it true, the instance configuration
// will be scrubbed and included in the returned map
func GetInfo(c Info, includeConfig bool) map[string]interface{} {
