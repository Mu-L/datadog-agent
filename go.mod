...
require (
	...
	github.com/DataDog/datadog-agent/pkg/gohai v0.50.0-rc.2
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.50.0-rc.2
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.50.0-rc.2
	github.com/DataDog/datadog-agent/pkg/security/secl v0.50.0-rc.2
	github.com/DataDog/datadog-agent/pkg/trace v0.50.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.50.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/log v0.50.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/pointer v0.50.0-rc.2
...
require (
	...
	github.com/DataDog/datadog-agent/comp/core/telemetry v0.50.0-rc.2
	github.com/DataDog/datadog-agent/pkg/aggregator/ckey v0.50.0-rc.2
	github.com/DataDog/datadog-agent/pkg/collector/check/defaults v0.50.0-rc.2
	...
	github.com/DataDog/datadog-agent/pkg/util/backoff v0.50.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/cache v0.50.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/common v0.50.0-rc.2
	github.com/DataDog/datadog-agent/pkg/util/compression v0.50.0-rc.2
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/util/buf v0.50.0-rc.2 // indirect
	github.com/DataDog/datadog-agent/pkg/util/system/socket v0.50.0-rc.2 // indirect
...
replace (
	github.com/aquasecurity/trivy => github.com/lebauce/trivy v0.0.0-20231031001347-0184442e282b
